package edu.tcu.cs.demo.bootstrap;

import edu.tcu.cs.demo.domain.*;
import edu.tcu.cs.demo.domain.security.Role;
import edu.tcu.cs.demo.enums.OrderStatus;
import edu.tcu.cs.demo.services.ProductService;
import edu.tcu.cs.demo.services.RoleService;
import edu.tcu.cs.demo.services.UserService;
...
public class SpringJPABootstrap implements ApplicationListener<ContextRefreshedEvent>{
    ...
    public void onApplicationEvent(ContextRefreshedEvent contextRefreshedEvent) {
        ...
        //loadCarts();//uncomment this will cause deleting product 1 FK reference problem.
        loadOrderHistory();
        loadRoles();
